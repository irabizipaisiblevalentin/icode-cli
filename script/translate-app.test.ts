...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".icode/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".icode/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".icode/glossary/zh-tw.md")
  })
