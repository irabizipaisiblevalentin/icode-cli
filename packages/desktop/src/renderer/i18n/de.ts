export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von iCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
