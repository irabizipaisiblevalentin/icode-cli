export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i iCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
