export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse iCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "iCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
