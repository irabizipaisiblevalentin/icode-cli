export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju iCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} iCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
