export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} iCode a fost descărcată. Vrei să o instalezi și să repornești?",
