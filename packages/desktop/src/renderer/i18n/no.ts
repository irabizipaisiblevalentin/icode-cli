export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av iCode er lastet ned. Vil du installere den og starte på nytt?",
