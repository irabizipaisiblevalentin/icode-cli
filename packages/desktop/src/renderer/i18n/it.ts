export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di iCode è stata scaricata. Vuoi installarla e riavviare l'app?",
