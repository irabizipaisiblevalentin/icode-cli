export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} iCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
