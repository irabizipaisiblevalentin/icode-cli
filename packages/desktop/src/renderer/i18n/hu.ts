export const dict = {
  ...
  "desktop.updater.none.message": "Már az iCode legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az iCode {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
