export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije iCode. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
