export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af iCode er blevet downloadet. Vil du installere den og genstarte?",
