export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av iCode har laddats ned. Vill du installera den och starta om programmet?",
