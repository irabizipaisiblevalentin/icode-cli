export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք iCode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "iCode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
