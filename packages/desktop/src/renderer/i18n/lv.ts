export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko iCode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "iCode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
