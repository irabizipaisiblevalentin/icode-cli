export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van iCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van iCode is gedownload. Wil je deze installeren en iCode opnieuw starten?",
