...
- Конфигурация проекта: `.icode/skills/<name>/SKILL.md`
...
Он загружает все соответствующие `skills/*/SKILL.md` в `.icode/` и все соответствующие `.claude/skills/*/SKILL.md` или `.agents/skills/*/SKILL.md` по пути.
...
Создайте `.icode/skills/git-release/SKILL.md` следующим образом:
...
Контролируйте, к каким навыкам агенты могут получить доступ, используя разрешения на основе шаблонов в `icode.json`:
...
**Для встроенных агентов** (в формате `icode.json`):
