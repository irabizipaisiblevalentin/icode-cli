...
- `.icode/plugins/` – плагины уровня проекта.
...
1. Глобальная конфигурация (`~/.config/opencode/icode.json`)
2. Конфигурация проекта (`icode.json`)
3. Глобальный каталог плагинов (`~/.config/opencode/plugins/`)
4. Каталог плагинов проекта (`.icode/plugins/`)
