...
2. **Konfigurer autentisering** ved å bruke en av følgende metoder:
   ...
   For prosjektspesifikk eller vedvarende konfigurasjon, bruk `icode.json`:
...
`icode.json` fil. Det anbefales også å deaktivere øktdeling.
...
4. Opprett eller oppdater `icode.json`-filen i prosjektkatalogen:
