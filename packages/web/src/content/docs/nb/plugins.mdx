...
- `.icode/plugins/` - Programtillegg på prosjektnivå
...
1. Global konfigurasjon (`~/.config/opencode/icode.json`)
2. Prosjektkonfigurasjon (`icode.json`)
3. Global plugin-katalog (`~/.config/opencode/plugins/`)
4. Prosjektpluginkatalog (`.icode/plugins/`)
