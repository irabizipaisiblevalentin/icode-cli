...
- Config di progetto: `.icode/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.icode/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.
...
Crea `.icode/skills/git-release/SKILL.md` cosi':
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `icode.json`:
...
**Per agenti integrati** (in `icode.json`):
