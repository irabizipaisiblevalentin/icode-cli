...
- `.icode/plugins/` - plugin a livello progetto
...
1. Config globale (`~/.config/opencode/icode.json`)
2. Config di progetto (`icode.json`)
3. Directory plugin globale (`~/.config/opencode/plugins/`)
4. Directory plugin di progetto (`.icode/plugins/`)
