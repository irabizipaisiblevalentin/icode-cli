...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `icode.json`:
...
file `icode.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `icode.json`:
...
4. Crea o aggiorna il tuo file `icode.json` nella directory del progetto:
