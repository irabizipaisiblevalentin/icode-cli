...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `icode.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
