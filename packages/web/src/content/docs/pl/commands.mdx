...
Utwórz `.icode/commands/test.md`:

```md title=".icode/commands/test.md"
---
...
Możesz zdefiniować polecenia w `icode.json` lub w plikach w katalogu `commands/`.
...
```md title=".icode/commands/component.md"
---
...
```md title=".icode/commands/create-file.md"
---
...
```md title=".icode/commands/analyze-coverage.md"
---
...
```md title=".icode/commands/review-changes.md"
---
...
```md title=".icode/commands/review-component.md"
---
