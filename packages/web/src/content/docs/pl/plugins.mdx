...
- `.icode/plugins/` - Wtyczki na poziomie projektu
...
1. Konfiguracja globalna (`~/.config/opencode/icode.json`)
2. Konfiguracja projektu (`icode.json`)
3. Globalny katalog wtyczek (`~/.config/opencode/plugins/`)
4. Katalog wtyczek projektu (`.icode/plugins/`)
