...
- إعدادات المشروع: `.icode/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.icode/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.
...
أنشئ `.icode/skills/git-release/SKILL.md` بهذا الشكل:
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `icode.json`:
...
**للوكلاء المدمجين** (في `icode.json`):
