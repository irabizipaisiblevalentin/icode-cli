...
- `.icode/plugins/` – Plugins auf Projektebene
...
1. Globale Konfiguration (`~/.config/opencode/icode.json`)
2. Projektkonfiguration (`icode.json`)
3. Globales Plugin-Verzeichnis (`~/.config/opencode/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.icode/plugins/`)
