...
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.icode/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.icode/themes/*.json`
...
```bash no-frame
mkdir -p .icode/themes
vim .icode/themes/my-theme.json
```
