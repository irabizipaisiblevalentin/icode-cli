...
- `.icode/plugins/` - ​​ปลั๊กอินระดับโครงการ
...
1. การกำหนดค่าส่วนกลาง (`~/.config/opencode/icode.json`)
2. การกำหนดค่าโครงการ (`icode.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/opencode/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.icode/plugins/`)
