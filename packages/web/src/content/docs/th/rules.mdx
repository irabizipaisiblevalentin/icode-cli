...
คุณสามารถระบุไฟล์คำแนะนำที่กำหนดเองได้ใน `icode.json` หรือ `~/.config/opencode/icode.json` ทั่วโลก สิ่งนี้ช่วยให้คุณและทีมของคุณสามารถนำกฎที่มีอยู่กลับมาใช้ใหม่ได้ แทนที่จะต้องทำซ้ำกฎเหล่านั้นกับ AGENTS.md
...
แนวทางที่แนะนำคือการใช้ฟิลด์ `instructions` ใน `icode.json`:
...
:::tip
สำหรับ monorepos หรือโปรเจ็กต์ที่มีมาตรฐานร่วมกัน การใช้ `icode.json` ที่มีรูปแบบ glob (เช่น `packages/*/AGENTS.md`) จะสามารถบำรุงรักษาได้ดีกว่าคำสั่งแบบแมนนวล
:::
