...
- การกำหนดค่าโครงการ: `.icode/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.icode/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง
...
สร้าง `.icode/skills/git-release/SKILL.md` แบบนี้:
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `icode.json`:
...
**สำหรับตัวแทนในตัว** (ใน `icode.json`):
