...
- Proje konfigurasyonu: `.icode/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.icode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.icode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`icode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`icode.json` icinde):
