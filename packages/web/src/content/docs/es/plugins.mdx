...
- `.icode/plugins/` - Complementos a nivel de proyecto
...
1. Configuración global (`~/.config/opencode/icode.json`)
2. Configuración del proyecto (`icode.json`)
3. Directorio global de complementos (`~/.config/opencode/plugins/`)
4. Directorio de complementos del proyecto (`.icode/plugins/`)
...
```ts title=".icode/plugins/my-plugin.ts"
...
```js title=".icode/plugins/example.js"
...
```js title=".icode/plugins/notification.js"
...
```javascript title=".icode/plugins/env-protection.js"
...
```javascript title=".icode/plugins/inject-env.js"
...
```ts title=".icode/plugins/custom-tools.ts"
...
```ts title=".icode/plugins/compaction.ts"
import type { Plugin } from "@opencode-ai/plugin"
...
```ts title=".icode/plugins/custom-compaction.ts"
import type { Plugin } from "@opencode-ai/plugin"
