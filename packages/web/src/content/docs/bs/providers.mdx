...
Za konfiguraciju specifičnu za projekat ili trajnu konfiguraciju, koristite `icode.json`:
...
`icode.json` fajl. Također se preporučuje da onemogućite dijeljenje sesije.
...
4. Kreirajte ili ažurirajte svoju `icode.json` datoteku u direktoriju projekta:
