...
- `.icode/plugins/` - Dodaci na nivou projekta
...
1. Globalna konfiguracija (`~/.config/opencode/icode.json`)
2. Konfiguracija projekta (`icode.json`)
3. Globalni direktorij dodataka (`~/.config/opencode/plugins/`)
4. Direktorij dodataka projekta (`.icode/plugins/`)
