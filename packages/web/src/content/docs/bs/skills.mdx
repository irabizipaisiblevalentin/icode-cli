...
- Konfiguracija projekta: `.icode/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.icode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.
...
Kreirajte `.icode/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `icode.json`:
...
**Za ugradene agente** (u `icode.json`):
