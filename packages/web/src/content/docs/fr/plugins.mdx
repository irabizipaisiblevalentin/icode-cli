...
- `.icode/plugins/` - Plugins au niveau du projet
...
1. Configuration globale (`~/.config/opencode/icode.json`)
2. Configuration du projet (`icode.json`)
3. Répertoire global des plugins (`~/.config/opencode/plugins/`)
4. Répertoire des plugins du projet (`.icode/plugins/`)
