...
- Configuration du projet : `.icode/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.icode/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.
...
Créez `.icode/skills/git-release/SKILL.md` comme ceci :
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `icode.json` :
...
**Pour les agents intégrés** (dans `icode.json`) :
