...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `icode.json`, mas você pode substituir ou adicionar configuração inline:
