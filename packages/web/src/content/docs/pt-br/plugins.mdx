...
- `.icode/plugins/` - Plugins em nível de projeto
...
1. Configuração global (`~/.config/opencode/icode.json`)
2. Configuração do projeto (`icode.json`)
3. Diretório de plugins global (`~/.config/opencode/plugins/`)
4. Diretório de plugins do projeto (`.icode/plugins/`)
