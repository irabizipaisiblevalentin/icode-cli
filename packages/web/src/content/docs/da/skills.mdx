...
- Prosjektkonfigurasjon: `.icode/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.icode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.icode/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `icode.json`:
...
**For innebygde agenter** (i `icode.json`):
