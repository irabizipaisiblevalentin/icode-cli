...
2. **Konfigurer godkendelse** ved at bruge en af følgende metoder:
   ...
   For projektspecifik eller vedvarende konfiguration, brug `icode.json`:
...
`icode.json` fil. Det anbefales også at deaktivere sessionsdeling.
...
4. Opret eller opdater `icode.json`-filen i projektkataloget:
