...
import type { MessageV2 } from "icode/session/message-v2"
import type { Message } from "icode/session/message"
import type { Session } from "icode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.icode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.icode_name}>
