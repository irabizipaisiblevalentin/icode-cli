...
export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "此发行版中未安装 opencode",
  "desktop.wsl.error.icodeCannotRun": "已安装 opencode，但无法运行",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}} 中未安装 OpenCode",
  ...
  "dialog.provider.icode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.icode.tagline": "可靠的优化模型",
  "dialog.provider.icodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.icodeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.icodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.icodeZen.visit.prefix": "访问 ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 icode.json 中配置的插件",
  ...
  "wsl.onboarding.icodeReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.icodeReady": "OpenCode 已就绪。",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "未安装 OpenCode",
  ...
  "error.chain.checkConfig": "请检查你的配置 (icode.json) 中的 provider/model 名称",
