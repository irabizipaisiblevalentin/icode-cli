export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.icodeMissing": "මෙම distro හි opencode ස්ථාපනය කර නොමැත",
  "desktop.wsl.error.icodeCannotRun": "opencode ස්ථාපනය කර ඇති නමුත් ධාවනය කල නොහැක",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} හි ස්ථාපනය කර නැත",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini සහ තවත් දේ ඇතුළුව සංවෘත ආකෘති",
  "dialog.provider.icode.tagline": "විශ්වසනීය ප්රශස්ත මාදිලි",
  "dialog.provider.icodeGo.tagline": "සෑම කෙනෙකුටම අඩු වියදම් දායකත්වයක්",
  ...
  "provider.connect.icodeZen.visit.prefix": "පිවිසෙන්න",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "ඔබගේ API යතුර එකතු කිරීමට.",
  ...
  "dialog.plugins.empty": "ප්ලගීන icode.json හි වින්‍යාස කර ඇත",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.icodeReady": "OpenCode සූදානම්.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode ස්ථාපනය කර නැත",
  ...
  "error.chain.checkConfig": "ඔබගේ වින්‍යාසය (icode.json) සපයන්නා/ආදර්ශ නම් පරීක්ෂා කරන්න",
