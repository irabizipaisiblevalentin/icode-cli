export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "ไม่ได้ติดตั้ง opencode ในดิสโทรนี้",
  "desktop.wsl.error.icodeCannotRun": "ติดตั้ง opencode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.icodeNotInstalled": "ไม่ได้ติดตั้ง OpenCode ใน {{distro}}",
  ...
  "dialog.provider.icode.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.icode.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.icodeGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "provider.connect.icodeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.icodeReady": "OpenCode พร้อมใช้งานแล้ว",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "ยังไม่ได้ติดตั้ง OpenCode",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (icode.json) ชื่อผู้ให้บริการ/โมเดล",
