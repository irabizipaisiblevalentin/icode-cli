export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.icodeCannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode chưa được cài đặt trong {{distro}}",
  ...
  "dialog.provider.icode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.icode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.icodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "provider.connect.icodeZen.visit.prefix": "Truy cập ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " để lấy khóa API của bạn.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode đã sẵn sàng.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode chưa được cài đặt",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (icode.json) của bạn",
