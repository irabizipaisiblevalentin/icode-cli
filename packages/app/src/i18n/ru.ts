export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode не установлен в этом дистрибутиве",
  "desktop.wsl.error.icodeCannotRun": "opencode установлен, но его не удалось запустить",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode не установлен в {{distro}}",
  ...
  "dialog.provider.icode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.icode.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.icodeGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.icodeZen.visit.prefix": "Посетите ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": ", чтобы получить ключ API.",
  ...
  "dialog.plugins.empty": "Плагины настроены в icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode в {{distro}} готов к работе.",
  "wsl.onboarding.icodeReady": "OpenCode готов к работе.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode не установлен",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (icode.json)",
