export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.icodeCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode nuk është i instaluar në {{distro}}",
  ...
  "dialog.provider.icode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.icode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.icodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "provider.connect.icodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode është gati në {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode është gati.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nuk është i instaluar",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (icode.json).",
