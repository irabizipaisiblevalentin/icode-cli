...
export const dict = {
  ...
  "dialog.provider.icode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.icode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.icodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "provider.connect.icodeZen.visit.prefix": "Látogatás",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  ...
  "dialog.plugins.empty": "Az icode.json fájlban konfigurált beépülő modulok",
  ...
  "wsl.onboarding.icodeReadyIn": "A OpenCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.icodeReady": "A OpenCode készen áll.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "A OpenCode nincs telepítve",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (icode.json) szolgáltató/modell nevét",
