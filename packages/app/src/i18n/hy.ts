export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.icodeCannotRun": "opencode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode տեղադրված չէ {{distro}}",
  ...
  "dialog.provider.icode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.icode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.icodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "provider.connect.icodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են icode.json-ում",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.icodeReady": "OpenCode պատրաստ է։",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode տեղադրված չէ",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (icode.json) մատակարարի/մոդելի անունները",
