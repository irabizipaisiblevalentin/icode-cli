export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.icodeCannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode nav instalēts {{distro}}",
  ...
  "dialog.provider.icode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.icode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.icodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "provider.connect.icodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode ir gatavs.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nav instalēts",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (icode.json) pakalpojuma/modela nosaukumus",
