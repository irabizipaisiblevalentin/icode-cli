export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode belum terinstal di distro ini",
  "desktop.wsl.error.icodeCannotRun": "opencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode belum terinstal di {{distro}}",
  ...
  "dialog.provider.icode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.icode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.icodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "provider.connect.icodeZen.visit.prefix": "Kunjungi ",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode siap di {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode siap.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode belum terinstal",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (icode.json)",
