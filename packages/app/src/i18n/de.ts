...
export const dict = {
  ...
  "dialog.provider.icode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.icode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.icodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.icodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In icode.json konfigurierte Plugins",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode ist in {{distro}} bereit.",
  "wsl.onboarding.icodeReady": "OpenCode ist bereit.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nicht installiert",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (icode.json)",
  ...
  "desktop.wsl.error.icodeMissing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.icodeCannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode ist in {{distro}} nicht installiert",
