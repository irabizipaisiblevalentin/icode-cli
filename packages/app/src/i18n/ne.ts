export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.icodeMissing": "Opencode यस distro मा स्थापित छैन",
  "desktop.wsl.error.icodeCannotRun": "opencode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} मा स्थापित छैन",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.icode.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.icodeGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "provider.connect.icodeZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  ...
  "dialog.plugins.empty": "icode.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} मा तयार छ।",
  "wsl.onboarding.icodeReady": "OpenCode तयार छ।",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode स्थापित छैन",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (icode.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
