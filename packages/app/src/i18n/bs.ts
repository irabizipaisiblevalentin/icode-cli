export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.icodeCannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode nije instaliran u distribuciji {{distro}}",
  ...
  "dialog.provider.icode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.icode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.icodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.icodeZen.visit.prefix": "Posjeti ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode je spreman.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nije instaliran",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (icode.json)",
