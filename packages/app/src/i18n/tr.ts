...
export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.icodeCannotRun": "opencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode, {{distro}} içinde kurulu değil",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.icode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.icodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.icodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler icode.json içinde yapılandırılır",
  ...
  "wsl.onboarding.icodeReadyIn": "{{distro}} içinde OpenCode hazır.",
  "wsl.onboarding.icodeReady": "OpenCode hazır.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode kurulu değil",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (icode.json) sağlayıcı/model adlarını kontrol edin",
