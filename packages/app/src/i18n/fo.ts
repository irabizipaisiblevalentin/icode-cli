export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.icodeCannotRun": "opencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode er ikki sett upp í {{distro}}",
  ...
  "dialog.provider.icode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.icode.tagline": "Álítandi optimerað modell",
  "dialog.provider.icodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "provider.connect.icodeZen.visit.prefix": "Vitja ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " fyri at savna tín API lykil.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode er klárt í {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode er klárt.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode ikki innstillað",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (icode.json) veitara/modell nøvn",
