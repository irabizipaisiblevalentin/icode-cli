export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.icodeCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode nie jest zainstalowany w dystrybucji {{distro}}",
  ...
  "dialog.provider.icode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.icode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.icodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "provider.connect.icodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nie jest zainstalowany",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (icode.json)",
