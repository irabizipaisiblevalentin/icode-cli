export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode در این توزیع نصب نشده است",
  "desktop.wsl.error.icodeCannotRun": "opencode نصب شده است اما اجرا نمی شود",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode در {{distro}} نصب نشده است",
  ...
  "dialog.provider.icode.note": "مدل های انتخاب شده از جمله Claude، GPT، Gemini و موارد دیگر",
  "dialog.provider.icode.tagline": "مدل های بهینه شده قابل اعتماد",
  "dialog.provider.icodeGo.tagline": "اشتراک کم هزینه برای همه",
  ...
  "provider.connect.icodeZen.visit.prefix": "بازدید کنید ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " برای جمع آوری کلید API.",
  ...
  "dialog.plugins.empty": "پلاگین های پیکربندی شده در icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode در {{distro}} آماده است.",
  "wsl.onboarding.icodeReady": "OpenCode آماده است.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode نصب نشده است",
  ...
  "error.chain.checkConfig": "نام ارائه دهنده/مدل پیکربندی (icode.json) خود را بررسی کنید",
