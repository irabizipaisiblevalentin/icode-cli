export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "इस डिस्ट्रो में opencode इंस्टॉल नहीं है",
  "desktop.wsl.error.icodeCannotRun": "opencode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}} में OpenCode इंस्टॉल नहीं है",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.icode.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.icodeGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "provider.connect.icodeZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.icodeZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  ...
  "dialog.plugins.empty": "प्लगइन icode.json में कॉन्फ़िगर किए गए हैं",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} में तैयार है।",
  "wsl.onboarding.icodeReady": "OpenCode तैयार है।",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode स्थापित नहीं है",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (icode.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
