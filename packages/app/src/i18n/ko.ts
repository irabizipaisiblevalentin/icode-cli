export const dict = {
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.icode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.icodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.icodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.icodeZen.visit.prefix": "다음 ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "icode.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(icode.json)의 공급자/모델 이름을 확인하세요",
  ...
  "wsl.onboarding.icodeReadyIn": "{{distro}}에서 OpenCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.icodeReady": "OpenCode가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode가 설치되지 않음",
  ...
  "desktop.wsl.error.icodeMissing": "이 배포판에 opencode가 설치되어 있지 않습니다",
  "desktop.wsl.error.icodeCannotRun": "opencode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}}에 OpenCode가 설치되어 있지 않습니다",
