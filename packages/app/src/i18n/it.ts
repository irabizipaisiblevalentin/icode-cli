export const dict = {
  ...
  "dialog.provider.icode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.icode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.icodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "provider.connect.icodeZen.visit.suffix": " per ottenere la tua chiave API.",
  ...
  "dialog.plugins.empty": "Plugin configurati in icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode è pronto in {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode è pronto.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode non installato",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (icode.json)",
  ...
  "desktop.wsl.error.icodeMissing": "opencode non è installato in questa distribuzione",
  "desktop.wsl.error.icodeCannotRun": "opencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode non è installato in {{distro}}",
