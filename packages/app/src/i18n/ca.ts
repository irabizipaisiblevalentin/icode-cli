export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.icodeCannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode no està instal·lat a {{distro}}",
  ...
  "dialog.provider.icode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.icode.tagline": "Models optimitzats fiables",
  "dialog.provider.icodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "provider.connect.icodeZen.visit.prefix": "Visita ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " per recollir la teva clau API.",
  ...
  "dialog.plugins.empty": "Connectors configurats a icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode està llest a {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode està llest.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode no instal·lat",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (icode.json).",
