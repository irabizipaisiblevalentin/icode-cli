export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.icodeCannotRun": "opencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} gurulmady",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.icode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.icodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "provider.connect.icodeZen.visit.prefix": "Sapar ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  ...
  "dialog.plugins.empty": "icode.json-de düzülen pluginler",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}}-de taýýar.",
  "wsl.onboarding.icodeReady": "OpenCode taýýar.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode gurulmady",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (icode.json) üpjün edijiniň / model atlaryny barlaň",
