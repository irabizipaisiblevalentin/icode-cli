...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode is not installed in this distro",
  "desktop.wsl.error.icodeCannotRun": "opencode is installed but could not run",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode is not installed in {{distro}}",
