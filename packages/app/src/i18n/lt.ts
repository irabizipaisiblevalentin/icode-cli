...
export const dict = {
  ...
  "dialog.provider.icode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.icode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.icodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "provider.connect.icodeZen.visit.prefix": "Aplankykite",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode yra paruoštas {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode yra paruoštas.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode neįdiegtas",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (icode.json) teikėjo / modelio pavadinimus",
