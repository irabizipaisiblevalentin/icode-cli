export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.icodeCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} da o'rnatilmagan",
  ...
  "dialog.provider.icode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.icode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.icodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "provider.connect.icodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " API kalitingizni olish uchun.",
  ...
  "dialog.plugins.empty": "icode.json da sozlangan plaginlar",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} da tayyor.",
  "wsl.onboarding.icodeReady": "OpenCode tayyor.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode o'rnatilmagan",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (icode.json) provayder/model nomlarini tekshiring",
