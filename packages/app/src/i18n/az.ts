export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.icodeCannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} distribütivində quraşdırılmayıb",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.icode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.icodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "provider.connect.icodeZen.visit.prefix": "",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər icode.json-da konfiqurasiya edilib",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}}-də hazırdır.",
  "wsl.onboarding.icodeReady": "OpenCode hazırdır.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode quraşdırılmayıb",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (icode.json) provayder/model adlarını yoxlayın",
