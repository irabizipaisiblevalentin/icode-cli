...
export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.icodeCannotRun": "opencode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode er ikke installert i {{distro}}",
  ...
  "dialog.provider.icode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.icode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.icodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.icodeZen.visit.prefix": "Besøk ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i icode.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (icode.json)",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode er klar i {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode er klar.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode er ikke installert",
