...
export const dict = {
  ...
  "dialog.provider.icode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.icode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.icodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "provider.connect.icodeZen.visit.prefix": "Heimsókn",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode er tilbúið í {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode er tilbúinn.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode ekki uppsett",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (icode.json) þjónustuveitu/módelheiti",
