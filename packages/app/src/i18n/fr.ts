export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.icodeCannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode n'est pas installé dans {{distro}}",
  ...
  "dialog.provider.icode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.icode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.icodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.icodeZen.visit.prefix": "Visitez ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode est prêt.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode non installé",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (icode.json)",
