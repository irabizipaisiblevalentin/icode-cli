...
export const dict = {
  ...
  "dialog.provider.icode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.icode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.icodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "provider.connect.icodeZen.visit.prefix": "Posjetiti",
  "provider.connect.icodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode je spreman u {{distro}}.",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (icode.json).",
