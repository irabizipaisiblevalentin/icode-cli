export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.icodeCannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode غير مثبت في {{distro}}",
  ...
  "dialog.provider.icode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.icode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.icodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.icodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode جاهز في {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode جاهز.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode غير مثبت",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (icode.json)",
