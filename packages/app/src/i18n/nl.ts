export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.icodeCannotRun": "opencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode is niet geïnstalleerd in {{distro}}",
  ...
  "dialog.provider.icode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.icode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.icodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "provider.connect.icodeZen.visit.prefix": "Ga naar ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " om je API-sleutel op te halen.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode is gereed in {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode is klaar.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode niet geïnstalleerd",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (icode.json)",
