...
export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "此發行版中未安裝 opencode",
  "desktop.wsl.error.icodeCannotRun": "已安裝 opencode，但無法執行",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}} 中未安裝 OpenCode",
  ...
  "dialog.provider.icode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.icode.tagline": "經過最佳化的可靠模型",
  "dialog.provider.icodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.icodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.icodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.icodeZen.visit.prefix": "造訪 ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 icode.json 中設定的外掛程式",
  ...
  "wsl.onboarding.icodeReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.icodeReady": "OpenCode 已就緒。",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "未安裝 OpenCode",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (icode.json) 中的 provider/model 名稱",
