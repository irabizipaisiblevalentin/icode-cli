export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode ni nameščen v tej distribuciji",
  "desktop.wsl.error.icodeCannotRun": "opencode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode ni nameščen v {{distro}}",
  ...
  "dialog.provider.icode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.icode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.icodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "provider.connect.icodeZen.visit.prefix": "Obisk ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " za prevzem ključa API.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode je pripravljen v {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode je pripravljen.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode ni nameščen",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (icode.json).",
