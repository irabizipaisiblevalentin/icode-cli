export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.icodeMissing": "এই ডিস্ট্রোতে opencode ইনস্টল করা নেই",
  "desktop.wsl.error.icodeCannotRun": "opencode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode {{distro}} এ ইনস্টল করা নেই",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.icode.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.icodeGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "provider.connect.icodeZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  ...
  "dialog.plugins.empty": "icode.json এ কনফিগার করা প্লাগইন",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.icodeReady": "OpenCode প্রস্তুত।",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode ইনস্টল করা নেই",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (icode.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
