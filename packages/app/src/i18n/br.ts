export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.icodeCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.icodeNotInstalled": "O OpenCode não está instalado em {{distro}}",
  ...
  "dialog.provider.icode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.icode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.icodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.icodeZen.visit.prefix": "Visite ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "O OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.icodeReady": "O OpenCode está pronto.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode não instalado",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (icode.json)",
