export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.icodeCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode በ{{distro}}] ውስጥ አልተጫነም",
  ...
  "dialog.provider.icode.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.icode.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.icodeGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "provider.connect.icodeZen.line1": "OpenCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.icodeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.icodeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  ...
  "dialog.plugins.empty": "plugins በ icode.json የተዋቀሩ",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.icodeReady": "OpenCode ዝግጁ ነው።",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCodeአልተጫነም",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (icode.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
