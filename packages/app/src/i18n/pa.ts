export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "اس ڈسٹرو وچ opencode انسٹال نئیں اے",
  "desktop.wsl.error.icodeCannotRun": "opencode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}} وچ OpenCode انسٹال نئیں اے",
  ...
  "dialog.provider.icode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.icode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.icodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "provider.connect.icodeZen.visit.prefix": "ویکھو ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  ...
  "dialog.plugins.empty": "icode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.icodeReady": "OpenCode تیار اے۔",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode انسٹال نئیں کیتا گیا",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (icode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
