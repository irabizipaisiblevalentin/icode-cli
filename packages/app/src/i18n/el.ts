export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.icodeCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode δεν είναι εγκατεστημένο στο {{distro}}",
  ...
  "dialog.provider.icode.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.icode.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.icodeGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "provider.connect.icodeZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode είναι έτοιμο.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode δεν έχει εγκατασταθεί",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (icode.json) ονόματα παρόχου/μοντέλων",
