export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.icodeCannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode pole installitud asukohta {{distro}}",
  ...
  "dialog.provider.icode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.icode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.icodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "provider.connect.icodeZen.visit.prefix": "Külastage ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " API võtme kättesaamiseks.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode on valmis {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode on valmis.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode pole installitud",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (icode.json) pakkuja/mudeli nimesid",
