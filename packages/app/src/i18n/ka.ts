export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.icodeCannotRun": "opencode დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode არ არის დაინსტალირებული {{distro}}",
  ...
  "dialog.provider.icode.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.icode.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.icodeGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "provider.connect.icodeZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია icode.json-ში",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.icodeReady": "OpenCode მზად არის.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode არ არის დაინსტალირებული",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (icode.json) პროვაიდერის/მოდელების სახელები",
