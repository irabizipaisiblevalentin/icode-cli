export const dict = {
  ...
  "dialog.provider.icode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.icode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.icodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "provider.connect.icodeZen.visit.prefix": "Avaa ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään icode.json-tiedostossa",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode on valmis jakelussa {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCodea ei ole asennettu",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (icode.json) palveluntarjoajien ja mallien nimet",
  ...
  "desktop.wsl.error.icodeMissing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.icodeCannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.icodeNotInstalled": "OpenCodea ei ole asennettu jakeluun {{distro}}",
