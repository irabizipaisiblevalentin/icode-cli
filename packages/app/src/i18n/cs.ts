export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode není v této distribuci nainstalováno",
  "desktop.wsl.error.icodeCannotRun": "opencode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode není nainstalován v {{distro}}",
  ...
  "dialog.provider.icode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.icode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.icodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.icodeZen.visit.prefix": "Návštěva ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode je připraveno v {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode je připraven.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode není nainstalováno",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (icode.json).",
