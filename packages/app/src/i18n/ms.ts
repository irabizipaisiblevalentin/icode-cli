export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.icodeCannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode tidak dipasang dalam {{distro}}",
  ...
  "dialog.provider.icode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.icode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.icodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "provider.connect.icodeZen.visit.prefix": "Layari",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode sedia digunakan.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode belum dipasang",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (icode.json) nama penyedia/model",
