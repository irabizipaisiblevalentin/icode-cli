export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "اس ڈسٹری بیوشن میں opencode انسٹال نہیں ہے",
  "desktop.wsl.error.icodeCannotRun": "opencode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}} میں OpenCode انسٹال نہیں ہے",
  ...
  "dialog.provider.icode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.icode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.icodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "provider.connect.icodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  ...
  "dialog.plugins.empty": "icode.json میں کنفیگر کردہ پلگ انز",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.icodeReady": "OpenCode تیار ہے۔",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode انسٹال نہیں ہے۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (icode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
