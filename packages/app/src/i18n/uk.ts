export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.icodeCannotRun": "opencode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode не встановлено в {{distro}}",
  ...
  "dialog.provider.icode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.icode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.icodeGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.icodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": ", щоб отримати ключ API.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode готовий до роботи.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode не встановлено",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (icode.json)",
