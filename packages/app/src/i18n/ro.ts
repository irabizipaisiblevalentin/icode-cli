export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode nu este instalat în această distribuție",
  "desktop.wsl.error.icodeCannotRun": "opencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode nu este instalat în {{distro}}",
  ...
  "dialog.provider.icode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.icode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.icodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "provider.connect.icodeZen.visit.prefix": "Vizitează",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "pentru a obține cheia ta API.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode este gata în {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode este gata.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode nu este instalat",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (icode.json)",
