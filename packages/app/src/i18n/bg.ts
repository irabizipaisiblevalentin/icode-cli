export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.icodeCannotRun": "opencode е инсталиран, но не може да стартира",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode не е инсталиран в {{distro}}",
  ...
  "dialog.provider.icode.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.icode.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.icodeGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "provider.connect.icodeZen.visit.suffix": "за да вземете своя ключ API.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode е готов в {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode е готов.",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (icode.json).",
