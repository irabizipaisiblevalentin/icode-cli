export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.icodeCannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode no está instalado en {{distro}}",
  ...
  "dialog.provider.icode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.icode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.icodeGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.icodeZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode está listo.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode no está instalado",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (icode.json)",
