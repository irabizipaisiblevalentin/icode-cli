...
export const dict = {
  ...
  "dialog.provider.icode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.icode.tagline": "Reliable optimized models",
  "dialog.provider.icodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.icodeZen.visit.prefix": "Visit ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode is ready.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode not installed",
  ...
  "error.chain.checkConfig": "Check your config (icode.json) provider/model names",
