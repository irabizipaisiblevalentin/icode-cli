export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.icodeCannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.icodeNotInstalled": "{{distro}}にはOpenCodeがインストールされていません",
  ...
  "dialog.provider.icode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.icode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.icodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.icodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.icodeZen.visit.prefix": " ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "icode.jsonで設定されたプラグイン",
  ...
  "wsl.onboarding.icodeReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.icodeReady": "OpenCodeの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCodeがインストールされていません",
  ...
  "error.chain.checkConfig": "config (icode.json) のプロバイダー/モデル名を確認してください",
