export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode är inte installerat i den här distributionen",
  "desktop.wsl.error.icodeCannotRun": "opencode är installerat men kunde inte köras",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode är inte installerat i {{distro}}",
  ...
  "dialog.provider.icode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.icode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.icodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "provider.connect.icodeZen.visit.prefix": "Besök ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " för att hämta din API-nyckel.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i icode.json",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode är redo i {{distro}}.",
  "wsl.onboarding.icodeReady": "OpenCode är redo.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode är inte installerat",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (icode.json)",
