export const dict = {
  ...
  "dialog.provider.icode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.icode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.icodeGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.icodeZen.visit.prefix": "Besøg ",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": " for at hente din API-nøgle.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i icode.json",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode er ikke installeret",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (icode.json)",
  ...
  "desktop.wsl.error.icodeMissing": "opencode er ikke installeret i denne distribution",
  "desktop.wsl.error.icodeCannotRun": "opencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode er ikke installeret i {{distro}}",
