export const dict = {
  ...
  "desktop.wsl.error.icodeMissing": "opencode дар ин паҳнкунӣ насб нашудааст",
  "desktop.wsl.error.icodeCannotRun": "opencode насб шудааст, аммо иҷро карда натавонист",
  "desktop.wsl.error.icodeNotInstalled": "OpenCode дар {{distro}} насб нашудааст",
  ...
  "dialog.provider.icode.note": "Моделҳои интихобшуда, аз ҷумла Claude, GPT, Gemini ва ғайра",
  "dialog.provider.icode.tagline": "Моделҳои боэътимоди оптимизатсияшуда",
  "dialog.provider.icodeGo.tagline": "Обунаи арзон барои ҳама",
  ...
  "provider.connect.icodeZen.visit.prefix": "Ташриф",
  "provider.connect.icodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.icodeZen.visit.suffix": "барои гирифтани калиди API худ.",
  ...
  "dialog.plugins.empty": "Плагинҳо дар icode.json танзим карда шудаанд",
  ...
  "wsl.onboarding.icodeReadyIn": "OpenCode дар {{distro}} тайёр аст.",
  "wsl.onboarding.icodeReady": "OpenCode тайёр аст.",
  ...
  "wsl.onboarding.distroStatus.icodeMissing": "OpenCode насб нашудааст",
  ...
  "error.chain.checkConfig": "Номҳои провайдери конфигуратсияи худро (icode.json) санҷед",
