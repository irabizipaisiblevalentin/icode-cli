...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("iCode")
      return
    }
  ...
  createEffect(() => {
    ...
    if (kv.get("greeted_iCode")) return
    kv.set("greeted_iCode", true)
    toast.show({ variant: "info", message: t("greeting"), duration: 6000 })
  })
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to iCode v${result.data.version}. Please restart the application.`,
    )
